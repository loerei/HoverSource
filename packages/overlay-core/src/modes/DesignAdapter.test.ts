...
const mockBody = { parentElement: null } as any;
...
describe("DesignAdapter - Relational Alignment and Offset (RAO) Helpers", () => {
  it("should find the nearest common ancestor", () => {
    ...
    const body = mockBody;
    const container = { parentElement: body } as any;
    const el1 = { parentElement: container } as any;
    const el2 = { parentElement: container } as any;
